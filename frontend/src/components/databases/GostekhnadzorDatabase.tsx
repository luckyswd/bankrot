...
export default function GostekhnadzorDatabase() {
  ...
  const [gostekhnadzorToDelete, setGostekhnadzorToDelete] =
    useState<GostekhnadzorItem | null>(null);
  const [editingGostekhnadzor, setEditingGostekhnadzor] =
    useState<GostekhnadzorItem | null>(null);
  ...
  const limit = 10;
  const gostekhnadzor =
    (referenceData.gostekhnadzor as GostekhnadzorItem[]) ?? [];
    ...
    <div className="space-y-6 p-6">
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {gostekhnadzorToDelete?.name}"? Это действие нельзя отменить.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {editingGostekhnadzor
                ? "Редактировать отделение"
                : "Новое отделение"}
            </DialogTitle>
            <DialogDescription>
              {editingGostekhnadzor
                ? "Измените данные отделения"
                : "Добавьте новое отделение Гостехнадзора в базу данных"}
            </DialogDescription>
          </DialogHeader>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Управление базой Гостехнадзора
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Все отделения Гостехнадзора в базе данных
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-4">
